> Historical plan for the original Proxy Lab implementation. The current UI redesign is planned in [implementation-plan.md](../../implementation-plan.md). Completion and pending hardware-validation status below are preserved from the original plan.
